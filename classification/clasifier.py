...
from classification.car_labels import car_labels
...
class Classifier:
    ...
    def __init__(self):
        self.model = tf.keras.models.load_model('model/classification/classification_model_4.h5')
        self.labels = car_labels
